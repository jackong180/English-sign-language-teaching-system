...
if __name__ == "__main__":
    ...
    #----------------------------------------------------------------------------------------------------------------------------#
    #   由于没有预训练权重，我们将从0开始训练
    #   设置model_path = ''，Freeze_Train = False，此时从0开始训练，且没有冻结主干的过程
    #   由于数据集较小，我们将设置较大的训练世代和适当的batch_size
    #----------------------------------------------------------------------------------------------------------------------------#
    model_path      = ''
    #------------------------------------------------------#
    ...
    #                           由于数据集较小，设置较小的batch_size
    #------------------------------------------------------------------#
    UnFreeze_Epoch      = 300
    Unfreeze_batch_size = 2
    #------------------------------------------------------------------#
    #   Freeze_Train    是否进行冻结训练
    #                   由于数据集较小且从0开始训练，不进行冻结训练
    #------------------------------------------------------------------#
    Freeze_Train        = False
